...
# MainConsumerクラス: WebSocketからの受け取ったものを処理するクラス
class MainConsumer( WebsocketConsumer ):

    # WebSocket接続時の処理
    def connect( self ):
        # グループに参加
        self.strGroupName = 'main'
    ...
    # （ブラウザ側のJavaScript関数のsocketMain.send()の結果、WebSocketを介してデータがMainConsumerに送信され、本関数で受信処理します）
    ...
    def main_message( self, data ):
        ...
        # （送信されたメッセージは、ブラウザ側のJavaScript関数のsocketMain.onmessage()で受信処理されます）
